...
export const BentoGridItem = ({
  ...
  const handleCopy = () => {
    navigator.clipboard.writeText('semfoudraine@gmail.com')
  ...
  return (
    <div
      ...
      style={{
        ...
        backgroundColor:
          'linear - gradient(90deg, rgba(2, 0, 36, 1) 0 %, rgba(0, 0, 0, 1) 24 %, rgba(93, 108, 111, 1) 100 %)',
      }}
    >
        ...
        <div className={cn(
          ...
          {id === 6 && (
            <div className="mt-5 relative">
              ...
              <MagicButton 
                title={copied ? 'Email gekopiërd' : 'Kopiër mijn email'}
                icon={<IoCopyOutline />}
                position="left"
